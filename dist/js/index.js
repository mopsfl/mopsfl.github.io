...
(0, import_jquery.default)(() => {
  (0, import_jquery.default)(".btns > a").on("click", (e) => {
    e.preventDefault();
    if (_cgb === true)
      return;
    if (!_.isNil(e.target.attributes["hrefdata"])) {
      ...
      setTimeout(async () => {
        if (hrefData == "projects") {
          ...
          await fetch("./static/json/projects.json", { method: "GET", headers }).then((res) => res.json()).then((data) => {
  ...
  (0, import_jquery.default)(".back").on("click", (e) => {
    e.preventDefault();
    if (!_cgb)
      return;
